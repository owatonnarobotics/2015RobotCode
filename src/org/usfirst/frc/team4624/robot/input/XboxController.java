...
public class XboxController extends Joystick {
     ...
     * constructor, you can specify which port you expect the controller to be
     * on.
     * 
     * @param port
     */
    ...
    /**
     * (Constructor #2) This is the other constructor. I would recommend using
     * this one instead as it is unlikely that anything else but the
     * XboxController will be connected.
     */
    ...
    public static enum DPAD {
        UP(0), UP_RIGHT(45), RIGHT(90), DOWN_RIGHT(135), DOWN(180), DOWN_LEFT(
                225), LEFT(270), UP_LEFT(315);
    ...
    /**
     * This class is used to represent the thumbsticks on the Xbox360
     * controller.
     */
